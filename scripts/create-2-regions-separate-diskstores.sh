...
~/geode/geode-assembly/build/install/apache-geode/bin/gfsh -e "connect --locator=geode-vm-0.c.data-g2c.internal[10334]" -e "create region --name=testRegion1 --type=PARTITION_PERSISTENT --disk-store=diskstore1" -e "create region --name=testRegion2 --type=PARTITION_PERSISTENT --disk-store=diskstore2"
